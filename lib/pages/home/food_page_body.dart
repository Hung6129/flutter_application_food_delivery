...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  double _currHeight = Dimensions.pageViewContainer;
  @override
  void initState() {
    super.initState();
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                child: SmallText(text: "Mlem mlem"),
              )
            ],
          ),
        ),
  ...
  Widget _buildPageItem(int index, ProductModel popularProductList) {
    ...
    if (index == _currPageValues.floor()) {
      var _currScale = 1 - (_currPageValues - index) * (1 - _scaleFactor);
      var _currTrans = _currHeight * (1 - _currScale) / 2;
